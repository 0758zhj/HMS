...
<%
	    ...
	    if(rs_1.next()){
	    	...
	    	day=chStr.getDaySub_int(checkIn_date,curdate);   //计算天数
	    	if(day==0){
	    		day=1;
	    	}
	    	cost=day*price;                                            //计算总费用
...
<html>
	...
	<body style="background: url(image/bg.jpg) repeat-y 100% 100%;">
		...
		<form onsubmit="return addCheck()" action="room-checkOut_deal.jsp" >
		<div class="g-bd" style="margin-top:50px">
			...
			<div class="g-wrap" id="baseBox">
				...
				<br/>
                     ...
                     <font size="3" >离开时间:<%=curdate%></font><br /><br /><br />
                      <font size="3" >天     数         :<%=day%></font><br /><br /><br />
                      <font size="3" >总      费    用:<%=cost%></font><br /><br /><br />
                      <font size="3" >押      金       :<%=deposit%></font><br /><br /><br />
                      <font size="3" >应      交       :<%=balance%></font><br /><br /><br />
                    <br /><br /><br /><br /><br /><br />
                    
                     
                     <div align="center">
                    
							<input onclick="location.href='room-checkOut_deal.jsp?roomID=<%=roomID%>'"  type="button" value="退房" style="width:60px;height:40px;"/>&nbsp;
