...
if (ret_1!=0){
	session.setAttribute("phone_order","null");
    out.println("<script language='javascript'>alert('退订成功！');window.location.href='index.jsp';</script>");
  }else{
    out.println("<script language='javascript'>alert('退订失败！');history.go(-1);</script>");
  }
