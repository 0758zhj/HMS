...
<div class="TopDiv">
    ...
    <div class="vbf">
        ...
        <form id="booking-form" class="inner"  onsubmit="return addCheck()" action="front_order_2_deal.jsp">
            <div class="form-group">姓   名：
                <input class="form-control" name="name_A" placeholder="输入第一个人的姓名" type="text">
            </div>
            <div class="form-group">手机号：
                <input class="form-control" name="phone_A" placeholder="输入第一个人的联系方式" type="text">
            </div>
            <div class="form-group">
                <div class="form_select">证件类型：
                    <select name="cardType_A"  id="select">
									<option value="1">
									    身份证   
									</option>
									<option value="2">
             ...
             <div class="form-group">证件号：
                <input class="form-control" name="cardNo_A" placeholder="输入第一个人的证件号" type="text">
            </div>
            
            <hr><br/>
            
            <div class="form-group">姓   名：
                <input class="form-control" name="name_B" placeholder="输入第二个人的姓名" type="text">
            </div>
            <div class="form-group">手机号：
                <input class="form-control" name="phone_B" placeholder="输入第二个人的联系方式" type="text">
            </div>
            <div class="form-group">
                <div class="form_select">证件类型：
                    <select name="cardType_B"  id="select">
									<option value="1">
									    身份证   
									</option>
									<option value="2">
             ...
             <div class="form-group">证件号：
                <input class="form-control" name="cardNo_B" placeholder="输入第二个人的证件号" type="text">
            </div>
            ...
            <div class="form-group">
                ...
                <!--onchange="javascript:location.href=this.value;" -->     
                    ...
                    <%
                    int roomID=0;
                    String  sql="select * from tb_room  where type='双人房'" +"and state='空闲' and isOrder=0 order by roomID asc";
