...
<html>
	...
	<body style="background: url(image/bg.jpg) repeat-y 100% 100%;">
		...
		<form onsubmit="return addCheck()" action="room-checkIn_2_deal.jsp" >
		    ...
		    <div class="g-wrap" id="baseBox">
				<div class="u-title u-title-2 f-cb"> 
					...
					&nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   &nbsp; &nbsp; 
                     ...
                     <font size="3" >证     件    号    ：<input type="text" class="u-txt txt" id="artistName"  name="cardNo_A" maxlength="30"></font>
                    <br />    
			</div>
			<hr>
