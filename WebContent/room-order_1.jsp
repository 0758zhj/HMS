...
<html>
	...
	<body style="background: url(image/bg.jpg) repeat-y 100% 100%;">
		...
		<form onsubmit="return addCheck()" action="room-order_1_deal.jsp" >
			...
			<div class="g-wrap" id="baseBox">
				...
				<br/>
                     ...
                     <font size="3" >预离时间:</font><input type="date" class="u-txt txt" id="datepicker_2" name="leave_date" style="height:30px;"><br /><br /><br />
                      ...
                      <font size="3" >押      金        :   <input type="text" class="u-txt txt" id="deposit"  name="deposit" maxlength="30"></font><br /><br /><br />
                    <br /><br /><br /><br /><br /><br />
                    
                     
                     <div align="center">
							<input  type="submit" value="预订" style="width:60px;height:40px;"/>&nbsp;
